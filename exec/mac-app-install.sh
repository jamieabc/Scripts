...
# ruby gems
gem install rubocop pry pry-doc pry-byebug awesome_print rspec ruby-beautify rufo gherkin cucumber minitest rake bundler httparty faraday flog
